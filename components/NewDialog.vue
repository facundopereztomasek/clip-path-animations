...
>
  <v-card tile>
    <v-toolbar flat dark color="primary">
      ...
      <v-toolbar-items>
        <v-btn dark text @click="addShape">Save</v-btn>
      </v-toolbar-items>
