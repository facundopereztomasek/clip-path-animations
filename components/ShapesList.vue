<template>
<v-card class="viewport" ref="viewport">
  <v-toolbar extended extension-height="10" class="shapes-header">
    <v-toolbar-title>Shapes</v-toolbar-title>
    <template v-slot:extension>
      <v-btn color="pink" dark small absolute bottom left fab @click="newShape">
  ...
  <v-list class="mt-2">
    <v-list-item v-if="shapes.length === 0">
...
export default {
  ...
  methods: {
    ...
    editShape(shapeUUID) {
      this.$store.commit('editShape', { shapeUUID })
    },
